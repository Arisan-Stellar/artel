...
export interface Client {
   ...
   */
  harvest_yield: ({pool_id, amount}: {pool_id: u32, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<YieldDistribution>>>
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    exit: this.txFromJSON<Result<i128>>,
        ...
        harvest_yield: this.txFromJSON<Result<YieldDistribution>>,
