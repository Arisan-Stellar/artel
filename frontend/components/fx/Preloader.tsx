...
export function Preloader() {
  ...
  return (
    <div
      ...
      aria-hidden
    >
      <ArtelLogo size={120} priority className="pre-mark h-28 w-28" />
      <div className="pre-word font-display mt-5 overflow-hidden text-3xl tracking-[0.3em]">
        <span className="inline-block">ROSCA Protocol</span>
      </div>
      <div className="pre-line mt-4 h-1 w-40 origin-left scale-x-0 bg-[var(--color-artel)]" />
    </div>
  );
}
