      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[960px] flex-col justify-center px-6 py-24">
        ...
        <div className="mt-14 flex flex-col items-stretch gap-6 sm:flex-row sm:items-center">
          <div className="flex flex-1 flex-col gap-4">
            <div
              className="brutal-card px-5 py-4"
              style={item(s(0.2, 0.34), -60)}
            >
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-crack)]">Layer 1</span>
              <p className="mt-1 text-sm font-semibold leading-snug text-black">{dict.nyala.streamCollateral}</p>
            </div>
            <div
              className="brutal-card px-5 py-4"
              style={item(s(0.3, 0.44), -60)}
            >
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-artel)]">Layer 2</span>
              <p className="mt-1 text-sm font-semibold leading-snug text-black">{dict.nyala.streamDues}</p>
            </div>
          </div>
          ...
          <div
            className="flex-1 border-[3px] px-6 py-8 text-center"
            style={{
          ...
          >
            <span className="text-[10px] font-black uppercase tracking-[0.2em] opacity-70">Layer 3 · Vault</span>
            <p className="mt-2 text-sm font-semibold leading-snug">{dict.nyala.streamYield}</p>
            <div className="mt-4 flex items-baseline justify-center gap-2">
              <span className="font-num text-4xl font-bold">{dict.nyala.apyLow}</span>
              <span className="text-lg">–</span>
              <span className="font-num text-4xl font-bold">{dict.nyala.apyHigh}</span>
            </div>
            <span className="mt-1 block text-xs font-semibold uppercase tracking-wider opacity-70">{dict.nyala.apyLabel}</span>
          </div>
        </div>
      </div>
    </section>
