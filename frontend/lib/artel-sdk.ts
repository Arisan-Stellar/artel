...
export const CONTRACT_IDS = {
  ...
  pool: process.env.NEXT_PUBLIC_CONTRACT_POOL || "CBVWEPXBBCPAK2A3NCCKIP6ORYB32VH3OKRQBUWNSMONQC5KEORPEQSN",
  // Active yield-vault (init + set_token done)
  vault: process.env.NEXT_PUBLIC_CONTRACT_VAULT || "CA65HU7KGU4EU4DGQYEQCCUBHAHFW6BOGCOKVRIIYGOOSYLSDH5WLIR7",
